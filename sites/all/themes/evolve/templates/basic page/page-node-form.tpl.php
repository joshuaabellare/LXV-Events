		...
		<div role="tabpanel" class="tab-pane" id="media">
			<div class="container-details">
				...
				<p class="custom-field-description centered">
					...
					<br>
					Image size should be: <strong>(1500x250)</strong> Upload size is <strong>500 KB</strong> or less.
				</p>
				<?php print render($form['field_image']); ?>
			</div>
			<br>
			<div class="container-details">
				<h3 class="no-margin centered uppercase">Video Link</h3>
				<hr class="container-details-line-separator">
				<p class="custom-field-description centered">Video link. E.g: Youtube video link.</p>
